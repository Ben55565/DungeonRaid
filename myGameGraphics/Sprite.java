...
public class Sprite {
	...
	// Spawn level sprites:
	public static Sprite spawnGrass = new Sprite(8, 0, 0, Spritesheet.spawn);
	public static Sprite spawnWater = new Sprite(8, 1, 0, Spritesheet.spawn);
	public static Sprite spawnHedge = new Sprite(8, 2, 0, Spritesheet.spawn);
	public static Sprite spawnWall = new Sprite(8, 0, 1, Spritesheet.spawn);
	public static Sprite spawnFloor = new Sprite(8, 1, 1, Spritesheet.spawn);
	public static Sprite spawnWallMoss = new Sprite(8, 0, 2, Spritesheet.spawn);
